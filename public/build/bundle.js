...
var app = (function () {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	function drawChart(data) {
    		const xScale = linear().domain([0, 20]).range([0, width]);
    		const yScale = linear().domain([0, 20]).range([height, 0]);
    	...
    	return [svg, m, b, svg_1_binding];
    }

    class Chart extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init$1(this, options, instance$1, create_fragment$1, safe_not_equal, { m: 1, b: 2 });
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			p = element("p");
    			p.textContent = "description here...";
    			t3 = space();
    			h3 = element("h3");
    			a0 = element("a");
    			...
    			attr_dev(h1, "class", "svelte-i6075t");
    			add_location(h1, file, 11, 8, 263);
    			attr_dev(p, "id", "desc");
    			attr_dev(p, "class", "svelte-i6075t");
    			add_location(p, file, 12, 8, 312);
    			attr_dev(a0, "href", "https://github.com/katemae");
    			add_location(a0, file, 14, 3, 383);
    			attr_dev(a1, "href", "https://github.com/jman2-go");
    			add_location(a1, file, 15, 7, 440);
    			add_location(br, file, 17, 3, 497);
    			attr_dev(h3, "id", "intro_date");
    			attr_dev(h3, "class", "svelte-i6075t");
    			add_location(h3, file, 13, 8, 358);
    			attr_dev(div0, "class", "intro svelte-i6075t");
    			add_location(div0, file, 10, 4, 234);
    			attr_dev(input0, "type", "range");
    			attr_dev(input0, "min", "-5");
    			attr_dev(input0, "max", "5");
    			attr_dev(input0, "step", "0.05");
    			attr_dev(input0, "class", "svelte-i6075t");
    			add_location(input0, file, 25, 23, 631);
    			add_location(span0, file, 26, 12, 712);
    			attr_dev(label0, "class", "svelte-i6075t");
    			add_location(label0, file, 24, 8, 599);
    			attr_dev(input1, "type", "range");
    			attr_dev(input1, "min", "0");
    			attr_dev(input1, "max", "10");
    			attr_dev(input1, "step", "0.05");
    			attr_dev(input1, "class", "svelte-i6075t");
    			add_location(input1, file, 29, 27, 793);
    			add_location(span1, file, 30, 12, 874);
    			attr_dev(label1, "class", "svelte-i6075t");
    			add_location(label1, file, 28, 8, 757);
    			attr_dev(div1, "class", "controls svelte-i6075t");
    			add_location(div1, file, 23, 4, 567);
    			add_location(main, file, 9, 0, 222);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			set_input_value(input0, /*$m*/ ctx[0]);
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*$m*/ 1) set_data_dev(t12, /*$m*/ ctx[0]);

    			if (dirty & /*$b*/ 2) {
    				set_input_value(input1, /*$b*/ ctx[1]);
    			}

    			if (!current || dirty & /*$b*/ 2) set_data_dev(t16, /*$b*/ ctx[1]);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const m = writable(1);
    	validate_store(m, 'm');
    	component_subscribe($$self, m, value => $$invalidate(0, $m = value));
    	const b = writable(0);
    	validate_store(b, 'b');
    	...
    	$$self.$capture_state = () => ({ Chart, writable, m, b, $m, $b });
    	return [$m, $b, m, b, input0_change_input_handler, input1_change_input_handler];
    }
